...
database[85477]     = true      -- Pristine Mogu Coin
database[85557]     = true      -- Pristine Pandaren Tea Set
database[85558]     = true      -- Pristine Game Board
...
database[89178]     = true      -- Pristine Twin Stein Set
database[89179]     = true      -- Pristine Walking Cane
database[89180]     = true      -- Pristine Empty Keg
database[89181]     = true      -- Pristine Carved Bronze Mirror
database[89182]     = true      -- Pristine Gold-Inlaid Figurine
database[89183]     = true      -- Pristine Apothecary Tins
database[89184]     = true      -- Pristine Pearl of Yu'lon
database[89185]     = true      -- Pristine Standard of Niuzao
database[89209]     = true      -- Pristine Monument Ledger
